...
public class ReadHbaseWeekendMapper extends
	...
	public static void main(String[] args) throws IOException {
		...
		String tablename = "gps";
		table = new HTable(conf, tablename);
		get = new Get(Bytes.toBytes("8e24bebf0087c77190a2353f0d157216"));
		result = table.get(get);
		...
		while (result.advance()) {
			...
			cell.getFamilyArray();
			qualifiername = cell.getQualifierArray();
			System.out.println(Bytes.toString(qualifiername));
			cellvalue = cell.getValueArray();
			stringvalue = Bytes.toString(cellvalue);
			stringvaluelist = stringvalue.split(",");
			...
			if (stringvaluelist.length == 2 || stringvaluelist.length == 3) {
				x = stringvaluelist[0];
				y = stringvaluelist[1];
				System.out.println("8e24bebf0087c77190a2353f0d157216" + "\t"
						+ Bytes.toString(qualifiername) + "\t" + x + "\t" + y);
