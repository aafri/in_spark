...
public class MatchUnit {
	...
	List<EntryUnit> entryUnit = new ArrayList<EntryUnit>();
	...
	public void addEntry(String fieldName, String matchType, String matchValue) {
		...
		entryUnit.add(new EntryUnit(fieldName,matchType,matchValue));
	}
	
	public List<EntryUnit> getEntryUnit(){
		return entryUnit;
	}
