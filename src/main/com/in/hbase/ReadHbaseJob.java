...
import com.in.hbase.ReadHbaseMapper;
import com.in.hbase.ReadHbaseWeekendMapper;
...
public class ReadHbaseJob extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {		
		int res = ToolRunner.run(new ReadHbaseJob(), args);
		System.exit(res);
...
public int run(String args[]) throws Exception {
	...
	//we put data into hbase first
		...
		job.setJarByClass(ReadHbaseJob.class);
...
//		job.setInputFormatClass(com.hadoop.mapreduce.LzoTextInputFormat.class);
	    ...
	    // HTable table = new HTable(hconf, args[1]); 
	     if(args.length==3 && args[2]=="workday"){
		   job.setMapperClass(ReadHbaseWorkdayMapper.class);
