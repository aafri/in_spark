...
public class GroupUnit{
	...
	List<com.in.config.EntryUnit> groupEntry = new ArrayList<com.in.config.EntryUnit>();
	...
	public void addGroupEntry(String fieldName, String matchType, String matchValue) {
		// TODO Auto-generated method stub
		groupEntry.add(new com.in.config.EntryUnit(fieldName,matchType,matchValue));
	}
	
	public List<com.in.config.EntryUnit> getGroupEntry(){
