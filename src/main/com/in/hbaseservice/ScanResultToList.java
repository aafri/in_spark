package main.com.in.hbaseservice;

import com.in.hbaseservice.*;
...
public class ScanResultToList {
       ...
       public List ResultToPhotoList2(ResultScanner rs) {
           ...
           List<com.in.hbaseservice.TwoTuple> list = new ArrayList<com.in.hbaseservice.TwoTuple>();
           ...
           for (Result result : rs) {
               ...
               while (result.advance()) {
                   ...
                   list.add(new com.in.hbaseservice.TwoTuple(Long.parseLong(lkey[2]), Long.parseLong(stringvalue)));
               }
           }
           return list;
