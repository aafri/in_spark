 ...
 *
 */
public class LogReducer extends Reducer<com.in.mapred.LogAggrKey, com.in.mapred.LogAggrValue, Text, Text> {

	/**
	 * Reduce the data
	 */
	public void reduce(com.in.mapred.LogAggrKey key,Iterable<com.in.mapred.LogAggrValue> values,Context context)
